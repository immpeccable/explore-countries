...
export default function ContentWrapper({ mode }) {
  ...
  return (
    <div className="content-wrapper">
      <div className="input-wrapper">
        <div className={`input-search-wrapper ${mode === "white" ? "input-search-wrapper-white" : "input-search-wrapper-dark"}`}>
          <img className="search-img"
            src={mode === "white" ? whiteModeSearch : darkModeSearch}
            alt="error"
          />
          <input
            className={`country-name ${mode === "white" ? "country-name-white" : "country-name-dark"}`}
            onChange={(e) => {
